...
\paragraph{7-4} Consider a BFS tree of an undirected graph. There can't be any forward edges because the descendant would have been discovered and processed as a child of the ancestor, making it a tree edge. There also can't be a back edge for the same reason: the edge would have been traversed---in the opposite direction---while processing $v$.
\begin{center}
\tikz[>={Stealth[round]}]
