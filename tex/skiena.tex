...
\begin{enumerate}[label=\arabic*)]
	...
	\tikz[>={Stealth[round]},
    	...
    	\draw[->] (1) -- (2);
    	\draw[->] (2) -- (T);
    }\,. Point \lstinline!head! to \lstinline!p->next! then free \lstinline!p!:\ %
    \tikz[>={Stealth[round]},
    	  every node/.style={inner sep=0pt, minimum size=1.7mm,draw}] {
    	\node[rectangle] (H) at (0,0) {};
...
\graph [tree layout, nodes={circle,inner sep=0pt, minimum size=1.3mm, draw, as=}] {
 1 -- 2 -- 3 -- 1;
};. It is clear that this graph is tripartite. More generally, no vertex canf have three neighbors that may force the use of a fourth color, so a graph with this property can be at most tripartite.\ \okthen
